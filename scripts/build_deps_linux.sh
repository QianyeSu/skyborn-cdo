...
wget -q "${HDF5_URL}" -O "hdf5-${HDF5_DIR_VERSION}.tar.gz" || \
    wget -q "https://support.hdfgroup.org/releases/hdf5/v${HDF5_DIR_VERSION}/downloads/hdf5-${HDF5_DIR_VERSION}.tar.gz" -O "hdf5-${HDF5_DIR_VERSION}.tar.gz"
